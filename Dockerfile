# Optimized MuPDF Worker - Fast incremental builds with BuildKit caching
# Usage: DOCKER_BUILDKIT=1 docker build -f Dockerfile.optimized -t worker .
...
# Stage 2: Build worker with truly static linking (FAST INCREMENTAL BUILDS)
